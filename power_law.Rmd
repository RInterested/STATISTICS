...
The gamma distribution can be thick-tailed or thin-tailed depending on its shape parameter (α).
...
**Chi-Squared Distribution**: A special case of the gamma distribution with $α = k/2$ and $β = 2.$ This connection is crucial in statistical hypothesis testing.
