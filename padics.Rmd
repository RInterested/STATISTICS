...
\begin{array}{rll}
   ...
   3 &\enclose{longdiv}{\phantom{0}\color{brown}{\bf 1}}\kern-.2ex \\[-3pt]
      ...
      &\phantom{00000}\color{red}{\bf{-10}} &\to \color{brown}{\bf{-2}} & \hbox{($\frac{\color{red}{\bf{-10}}}{p} = \color{brown}{\bf{-2}}\equiv 3\mod(5)$)}\quad\hbox{$\frac{\color{red}{\bf{-10}}}{p}=3\,(x_2+ x_3\,p+\cdots)$} \\[3pt]
