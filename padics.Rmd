...
\begin{array}{rll}
   ...
   3 &\enclose{longdiv}{\phantom{0}1}\kern-.2ex \\[-3pt]
      & \underline{-6} && \hbox{($\color{blue}{2} \times 3 = 6\equiv 1\mod(5)$)}\quad\hbox{($1=3(\color{blue}2p^0 +x_1 p^1 + x_2p^2+ x_3p^3+\cdots)$)} \\[-3pt]
      &-5\phantom{0}\to -1 && \hbox{($-5/p = -1\equiv 4\mod(5)$)}\quad\hbox{($-5/p=3(x_1 + x_2p^1+ x_3p^2+\cdots)$)} \\[-3pt]
      &\phantom{0000000}\underline{-9\phantom{0}} && \hbox{($\color{red}{3} \times 3 =9 \equiv 4 \mod(5)$)} \quad\hbox{($-1=3(\color{red}3p^0 + x_2p^1+ x_3p^2+\cdots)$)}\\[-3pt]
