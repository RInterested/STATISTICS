...
\begin{array}{rll}
   ...
   3 &\enclose{longdiv}{\phantom{0}\color{brown}{\bf 1}}\kern-.2ex \\[-3pt]
      ...
      &\color{red}{\bf{-5}}\phantom{0}\to \color{brown}{\bf{-1}} && \hbox{($\frac{\color{red}{\bf{-5}}}{p} = \color{brown}{-1}\equiv 4\mod(5)$)}\quad\hbox{($\frac{\color{red}{\bf{-5}}}{p}=3\,(x_1 + x_2\,p^1+ x_3\,p^2+\cdots)$)} \\[3pt]
      ...
      &&\phantom{000}\underline{-\color{orange}{\bf{3}}} & \hbox{($\color{magenta}{1} \times 3 = 3\equiv 3\mod(5)$)}\quad\hbox{($-2=3(\color{magenta}1p^0 + x_3p^1+\cdots)$)} \\[-3pt]
       &&\phantom{00}-5 \to -1 & \hbox{($-5/p = -1\equiv 4\mod(5)$)}\quad\hbox{($-5/p=3(x_3+\cdots)$)} \\[-3pt]
       &&\phantom{00000000}-9 & \hbox{($\color{green}{3} \times 3 = 9\equiv 4\mod(5)$)}\quad\hbox{($-1=3(\color{green}3p^0 +\cdots)$)}\\[-3pt]
       &&&\vdots
  \end{array}
$$
