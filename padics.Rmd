...
$$\frac 1 3 = \frac {c_1}{10} + \frac {c_2}{10^2} + \frac {c_3}{10^3}+ \dots  $$

Multiplying $\times 3$

$$1= 3\left( \frac {c_1}{10} + \frac {c_2}{10^2} + \frac {c_3}{10^3}+ \dots \right)  $$

gets us to the point when we have to add a zero $0$ to the right of $1$ to find $c_1$ (i.e. multiply $\times 10$. Naturally, $c_0=0.$
...
and we see that $C_2=3.$ Etcetera.

This is mirrored in the p-adics. For instance, $1/3$ in $\mod \mathbb Q_5:$
...
The pattern for a $p$-adic number is $a_0 + a_1\,p + a_2\,p^2+\cdots$ with $a_i\in\{0,\dots, p-1\}.$ 
...
Notice that this is different from $3 \mod 2$, in which the series is $3 = 1 \times 2^0 + 1 \times 2^1$. 
...
Now, how are the finite digits ($.011$) to the right of the period calculated in an expression such as $...10101010101010101.011$, and where do they come from?
